      ...
      {sizes.map((size) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex min-h-[44px] min-w-[112px] shrink-0 flex-col rounded-xl border px-3 py-2.5 text-left transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-primary)]/40",
              isActive
          ...
          >
            <div className="flex items-center justify-between gap-1">
              ...
              {isActive && (
                <svg className="h-3.5 w-3.5 text-[var(--brand-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
