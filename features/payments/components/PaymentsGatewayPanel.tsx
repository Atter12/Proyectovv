...
interface PaymentsGatewayPanelProps {
  session: SessionUser;
  /** TikTok advertiser ids of the selected Hecom cliente — scopes “asignar saldo”. */
      ...
      {hecomAdvertiserIds != null && scopedAccounts.length === 0 ? (
        ...
        >
          ...
          <p className="mt-1.5 max-w-2xl text-[13px] leading-5 text-[#6b645c]">
            ...
            no hay cuentas ads de Holistic vinculadas a esos advertiser IDs. No
            se muestran cuentas de otros clientes.
          </p>
          <Link
