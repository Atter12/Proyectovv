          ...
          <div className="relative flex flex-col gap-4 pl-2 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              <Link
                ...
                className="inline-flex h-9 items-center rounded-lg bg-[#e85a1c] px-3.5 text-[13px] font-semibold text-white hover:bg-[#d14e16]"
              >
                Ver cuentas ads
              </Link>
              <Link
                href={`/clientes/${cliente.id}`}
                className="inline-flex h-9 items-center rounded-lg border border-[rgb(20_18_16_/_0.1)] bg-white px-3.5 text-[13px] font-semibold text-[#2a241f] hover:bg-[#f6f0e8]"
              >
                Ver ficha
              </Link>
            </div>
          ...
          <div className="grid sm:grid-cols-3">
            {kpis.map((kpi, index) => (
              ...
              >
                ...
                <p className="mt-1 pl-2 text-[1.2rem] font-semibold tracking-[-0.03em] tabular-nums text-[#1a1612]">
                  {kpi.value}
                </p>
      ...
      {rows.length === 0 ? (
        <div className="px-5 py-10">
          ...
          <a
            ...
            className="mt-3 inline-flex text-[12px] font-semibold text-[#c45a18] underline-offset-2 hover:underline"
          >
            Ir a subir creativo
          </a>
        </div>
            ...
            return (
              ...
              >
                ...
                <span
                  className={
                    row.published
                      ? "shrink-0 rounded-md bg-[#ecf7f0] px-1.5 py-0.5 text-[10px] font-semibold text-[#1f5c40] ring-1 ring-emerald-200/80"
                      : "shrink-0 rounded-md bg-[#f0e9e0] px-1.5 py-0.5 text-[10px] font-semibold text-[#7a736a] ring-1 ring-[rgb(20_18_16_/_0.08)]"
                  }
                >
