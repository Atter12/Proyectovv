  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#f5f7fb] px-4">
      <div className="w-full max-w-md rounded-2xl border border-[#e5e7eb] bg-white p-8 text-center shadow-sm">
        <p className="text-sm font-semibold text-[var(--brand-primary)]">404</p>
        ...
        <Link
          href={routes.login}
          className="mt-6 inline-flex h-10 items-center rounded-xl bg-[var(--brand-primary)] px-5 text-sm font-semibold text-white transition-colors hover:bg-[var(--brand-primary)]/90"
        >
          Ir al inicio
        </Link>
      </div>
