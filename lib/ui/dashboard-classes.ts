...
export const dashboardClasses = {
  ...
  tabPanel:
    "dashboard-surface-card rounded-b-[1.35rem] rounded-tr-[1.35rem] border border-t-0 border-[var(--panel-line,var(--border-subtle))] shadow-[0_14px_36px_rgb(15_30_52_/_0.06)] backdrop-blur-xl",
} as const;
