    ...
    <header className="dashboard-glass sticky top-0 z-20 flex h-16 min-h-[64px] items-center justify-between gap-3 border-b border-[rgb(20_18_16_/_0.08)] px-4 sm:px-5 lg:px-6">
      <div className="flex min-w-0 flex-1 items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[11px] font-medium uppercase tracking-[0.14em] text-[var(--brand-primary-deep)]">
            {siteConfig.name}
          </p>
          <h1 className="truncate text-[1.15rem] font-medium tracking-[-0.015em] text-[#141210] sm:text-[1.25rem]">
            {pageTitle}
          </h1>
        </div>
      </div>
